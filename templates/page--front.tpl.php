...
<div role="document" class="page"> 
  ...
  <main role="main" class="row l-main">
    ...
    <aside role="complementary" class="<?php print $sidebar_first_grid; ?> l-sidebar-first columns sidebar"> <?php print render($page['sidebar_first']); ?> </aside>
    <?php endif; ?>
    <?php if (!empty($page['sidebar_second'])): ?>
    <aside role="complementary" class="<?php print $sidebar_sec_grid; ?> l-sidebar-second columns sidebar"> <?php print render($page['sidebar_second']); ?> </aside>
    <?php endif; ?>
  </main>
  <!--/.l-main--> 
  ...
  <ul class="example-orbit" data-orbit>
    <li> <img src="<?php print base_path() . drupal_get_path('theme', 'drupal_theme_foundation') ;?>/images/slide1.jpg" alt="slide 1" /> 
      <!--<div class="orbit-caption">
      Caption One.
    </div>--> 
    </li>
    <li> <img src="<?php print base_path() . drupal_get_path('theme', 'drupal_theme_foundation') ;?>/images/slide2.jpg" alt="slide 2" /> </li>
    <li> <img src="<?php print base_path() . drupal_get_path('theme', 'drupal_theme_foundation') ;?>/images/slide3.jpg" alt="slide 3" /> </li>
  </ul>
  <?php endif; ?>
  ...
  <div class="row">
    <div class="columns large-12">
      <ul class="client-logo">
        ...
        <li><a href="#"><img alt="client2" src="/sites/all/themes/drupal_theme_foundation/images/client2.png"></a></li>
        <li><a href="#"><img alt="client3" src="/sites/all/themes/drupal_theme_foundation/images/client3.png"></a></li>
        <li><a href="#"><img alt="client4" src="/sites/all/themes/drupal_theme_foundation/images/client4.png"></a></li>
        <li><a href="#"><img alt="client5" src="/sites/all/themes/drupal_theme_foundation/images/client5.png"></a></li>
        <li><a href="#"><img alt="client6" src="/sites/all/themes/drupal_theme_foundation/images/client6.png"></a></li>
        <li><a href="#"><img alt="client7" src="/sites/all/themes/drupal_theme_foundation/images/client7.png"></a></li>
        <li><a href="#"><img alt="client8" src="/sites/all/themes/drupal_theme_foundation/images/client8.png"></a></li>
      </ul>
    </div>
  </div>
</div>
